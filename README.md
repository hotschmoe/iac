...
### M4: Deep Systems
Loot system (components, data fragments). Morning Light Mountain faction with scaling difficulty. Auto-action policy system. LLM agent reference implementation.
